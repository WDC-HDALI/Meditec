page 50013 WDCSerialNoInformationList
{
    ...
    var
        CartonTrackingLines: Record 50010;
        lItem: Record Item;
        lItemLedgEnt: Record "Item Ledger Entry";
    begin
        // IF CloseAction IN [ACTION::OK, ACTION::LookupOK] THEN BEGIN
        //     CartonTrackingLines.Reset();
        //     CartonTrackingLines.SetRange("Serial No.", Rec."Serial No.");
        //     CartonTrackingLines.SetRange("Item No.", '');
        ...
        //         lItemLedgEnt.SetRange("Item No.", Rec."Item No.");
        //         if lItemLedgEnt.FindFirst() then
        //             CartonTrackingLines."Lot No." := lItemLedgEnt."Lot No.";
        //         CartonTrackingLines."Item No." := Rec."Item No.";
        //         CartonTrackingLines.Quantity := 1;
        //         CartonTrackingLines."Variant Code" := Rec."Variant Code";
        //         CartonTrackingLines."Item No." := Rec."Item No.";
        //         lItem.Get(Rec."Item No.");
        //         CartonTrackingLines."Item Description" := lItem.Description;
        //         CartonTrackingLines.Modify();
        //     end;
