report 50012 "WDC Sales Invoice Proforma"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ShiptoCountryRegion; "Ship-to Country/Region Code") //HD08032022
            {
            }
            ...
            dataitem(WorkDescriptionLines; "Integer")
            {
                ...
                begin
                    if WorkDescriptionInstream.EOS then
                        CurrReport.Break();
                    WorkDescriptionInstream.ReadText(WorkDescriptionLine);//2309
                    NumeroDescription += 1;
                    Groupe := ((NumeroDescription - 1) div 23) + 1; //HD 111021
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(TvaNotNull; TvaNotNull)  //Hd
                {
                }
            ...
            dataitem(integer; integer)
            {
                ...
                begin
                    SETRANGE(Number, 1, 23 - NumeroDescription mod 23);
            ...
            dataitem(VATAmountLine; "VAT Amount Line")
            {
                ...
                {
                    AutoFormatExpression = Line."Currency Code";
                    AutoFormatType = 1;
                }
            ...
            begin
                ...
                */
                ...
                //>>WDC  
                CuTTLettre."Montant en texteDevise"(MtTtLettres, Header."Amount Including VAT", Header."Currency Code");
    ...
    var
        ...
        Groupe: Integer;
        TotalRemise: Decimal;
        GsalesLine: Record "Sales line";//"Sales invoice line";
        PhoneNo: Text[30];
        FaxNo: Text[30];
