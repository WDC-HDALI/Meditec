report 50008 "WDC Vendor Det Trial Bal FR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/VendorDetailTrialBalance.RDL';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(Date; Date)
            {
                ...
                begin
                    ...
                    // CurrReport.PrintOnlyIfDetail := ExcludeBalanceOnly or (BalanceLCY = 0); //CMNT WDC01
                end;
            }
